            ...
            <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer"
                    ...
                    <tr role="row">
                        ...
                        <th tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1"
                            aria-label="Domain: activate to sort column ascending">Month
                        </th>
                        <th tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1"
                            aria-label="Domain: activate to sort column ascending">PM Name
                        </th>
                        <th tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1"
                            aria-label="Domain: activate to sort column ascending">Work
                        </th>
                        <th tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1"
                            aria-label="Domain: activate to sort column ascending">Information
                        </th>
                        <th tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1"
                    ...
                    @foreach($reports as $report)
                        @include('template.partials.elements.pm_visit_a2_table_row')
                    @endforeach
