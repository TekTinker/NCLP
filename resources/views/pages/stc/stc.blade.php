	...
	<div class="col-xs-12">
		...
		<div class="clearfix">
			<div class="pull-right tableTools-container">
				<a href="{{ route('stcs.create') }}">
					<button class="btn btn-app btn-success btn-sm">
						<i class="ace-icon fa fa-plus bigger-200"></i>
						Add
					</button>
				</a>
				<a class="btn btn-app btn-yellow btn-sm" href="{{ route('stcs.index') }}">
		...
		<div class="table-header">
			List of all Special Training Centers (STC).
		</div>
		...
		<div>
			<div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
				...
				<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer"
					...
					@foreach($stcs as $stc)
						@include('template.partials.elements.stc_table_row')
					@endforeach
